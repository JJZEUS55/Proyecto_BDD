...
INSERT INTO `bibliotecario` VALUES (5,'agus','Jorge','Santana','Martinez','Balm',50,2,700.00,'L',3),(6,'sandra','sandra','huesca','muñoz','d',5,5,800.00,'A',1),(7,'juan','juan','caballero','reyes','5d',12,12,1000.00,'a',1);
...
INSERT INTO `editorial` VALUES (1,'DE BOLSILLO'),(2,'SALAMANDRA'),(4,'ALIANZA'),(5,'HARPER'),(6,'REIMPRESA'),(7,'EDHASA');
...
INSERT INTO `libro` VALUES (2,'EL PSICOANALISTA',450,1,2010,2,2),(3,'HP',700,10,2010,2,3),(5,'LA TREGUA',216,6,2006,4,18),(6,'CIEN ANOS DE SOLEDAD',512,4,1987,5,4),(7,'GRACIAS POR EL FUEGO',288,2002,202,6,18),(8,'PRIMAVERA CON UNA ESQUINA ROTA',252,5,2007,7,18);
...
INSERT INTO `prestamo` VALUES (0000000007,0000000002,00000009,'2017-02-18','2017-02-25',5,3),(0000000008,0000000003,00000010,'2012-10-17','2012-12-17',6,1);
...
INSERT INTO `telefono_biblioteca` VALUES (1,'57619654');
...
INSERT INTO `telefono_usuario` VALUES (0000000001,'57619654');
...
INSERT INTO `usuario` VALUES (0000000001,'CHARLIS','855','CARLOS EDUARDO','CABALLERO','HUESCA','PUGIBET',22,11),(0000000002,'YISUS','123','JESUS','CABALLERO','HUESCA','ARCOS BELEN',12,50),(0000000003,'pumas_03','123','CARLA','MARIA','GARCIA','TOCHAPA',22,1);
...
-- Dump completed on 2017-02-20  0:01:42
