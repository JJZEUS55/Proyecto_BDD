...
import Controlador.CtrlBajaGenero;
 ...
 */
public class BajaGenero extends JFrame {
    
    private JLabel mensaje;
    private JTextField nombre;
    private JButton salir,eliminar,buscar;
    private final CtrlBajaGenero controlador;
    
    public BajaGenero(){
        controlador = new CtrlBajaGenero(this);
        configurarVentana(200,210);
        inicializarComponentes(); 
    }
    
    private void configurarVentana(int ancho, int alto){
        this.setTitle("Eliminar Genero");
    ...
    private void inicializarComponentes(){
        ...
        mensaje.setText("Eliminar Genero");
