...
import Interfaces.alta.AltaEditorial;
 ...
 */
public class CtrlAltaEditorial implements ActionListener,FocusListener{
    
    private final AltaEditorial vista;
    private Editorial modelo;
    
    public CtrlAltaEditorial(AltaEditorial vista){
        this.vista = vista;
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource() == vista.getBuscar()){
            ...
            if(ae.getSource() == vista.getActualizar()){
                ...
                modelo = new Editorial (auxNombre,nombre);
