...
import Interfaces.baja.BajaEditorial;
 ...
 */
public class CtrlBajaEditorial implements ActionListener, FocusListener {
    
    private BajaEditorial vista;
    private Editorial modelo;

    public CtrlBajaEditorial(BajaEditorial vista) {
        this.vista = vista;
    }
